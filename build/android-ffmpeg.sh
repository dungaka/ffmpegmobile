...
EXTRA_OPTIONS="--disable-decoders --enable-decoder=h263,h264,hevc,vp3,vp5,vp6,vp6a,vp6f,vp7,vp8,vp9,flv,h264_mediacodec,hevc_mediacodec,mpeg4_mediacodec,vp8_mediacodec,vp9_mediacodec,mpeg1video,mpeg2video,mpegvideo,mpeg4,dca,ac3,eac3,aac,mp1,mp2,mp3,rv30,rv40,cook,wmv1,wmv2,wmv3,wmv3image,vorbis,ape,flac,opus,wmav1,wmav2,wmapro,mjpeg,msmpeg4v1,msmpeg4v2,msmpeg4v3,tscc,gsm,gsm_ms,amrnb,amrwb,alac,sipr,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,ass,dvbsub,dvdsub,mov_text,movtext,sami,srt,ssa,subrip,text,gif,jpeg*,mjpeg*,png,apng,bmp --disable-demuxers --enable-demuxer=rm,mpegvideo,mjpeg,image2,avi,h263,h264,hevc,matroska,dts,dtshd,aac,flv,mpegts,mpegps,mp4,m4v,mov,ape,hls,flac,amr,rawvideo,realtext,rtsp,vc1,mp3,wav,asf,ogg,concat,sdp,gif,ass --disable-parsers --enable-parser=h263,h264,hevc,mpegaudio,mpegvideo,aac_latm,mpeg4video,dca,aac,ac3,eac3,flac,gif,png,bmp,vorbis,mjpeg --disable-encoders --enable-encoder=libx264,mpeg1video,mpeg2video,mpeg4,mjpeg,aac --disable-muxers --enable-muxer=mpegts,flv,mp4,hls,image2 "
